...
public class GeneratedLicenseNotRequired implements HeaderMatcher {
	...
	/**
	 * @param linePatterns the linePatterns to set
	 */
	public void setLinePatterns(Pattern... linePatterns) {
		this.linePatterns = linePatterns;
	}
    ...
    private void reportOnLicense(Document subject) {
        subject.getMetaData().set(MetaData.LICENSE_FAMILY_CATEGORY_DATUM_GEN);
    }
}
