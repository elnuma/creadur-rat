 ...
 * 
 */
public class GeneratedLicenseNotRequired implements HeaderMatcher {
	...
	public GeneratedLicenseNotRequired(final String... lines) {
		this.linePatterns = new Pattern[0];
		this.phrases = lines;
	}

	/**
	 * @return the linePatterns
	 */
	public Pattern[] getLinePatterns() {
		return linePatterns.clone();
	}

	/**
	 * @param linePatterns
	 *            the linePatterns to set
	 */
	public void setLinePatterns(final Pattern... linePatterns) {
		this.linePatterns = linePatterns;
	}
